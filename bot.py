    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("کانال سریال های ترکی", url="https://t.me/gemtv70")
                    ]
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/dlchinHub)",
                                     disable_web_page_preview=True)
            return
...
async def sts(_, m: Message):
    ...
    await m.reply_text(
        text=f"**👥 تعداد کاربران ربات :** `{total_users}`",
        quote=True
    )
    ...
    if "aboutbot" in cb_data:
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://github.com/Z/TG-FileStore")
                    ],
                    [
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("کانال سریالهای ترکی", url="https://t.me/gemtv70")
                    ]
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/dlchinHub).",
                        disable_web_page_preview=True
                    )
                    return
